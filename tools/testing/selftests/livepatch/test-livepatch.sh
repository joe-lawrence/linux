...
echo -n "TEST: klp-convert symbols (late module patching)... "
dmesg -C
...
echo -n "TEST: klp-convert symbols across ELF sections ... "
dmesg -C
...
echo -n "TEST: klp-convert static keys (late module patching)... "
dmesg -C
