 ...
 */
__attribute__((section(".text.print_saved_command_line"))) void
print_saved_command_line(void)
{
	pr_info("saved_command_line (1): %s\n", saved_command_line);
}

__attribute__((section(".text.print_saved_command_line2"))) void print_saved_command_line2(void)
{
	pr_info("saved_command_line (1): %s\n", saved_command_line);
	pr_info("saved_command_line (2): %s\n", saved_command_line);
}

__attribute__((section(".text.print_saved_command_line3"))) void print_saved_command_line3(void)
{
	pr_info("saved_command_line (1): %s\n", saved_command_line);
	pr_info("saved_command_line (2): %s\n", saved_command_line);
